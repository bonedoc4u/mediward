  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col items-center py-10 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl w-full bg-white rounded-2xl shadow-sm border border-slate-100 overflow-hidden">
        ...
        {/* Content */}
        <div className="px-6 py-8 sm:p-10 prose prose-slate max-w-none prose-h2:text-slate-800 prose-h2:mt-8 prose-h2:mb-4 prose-p:text-slate-600 prose-p:leading-relaxed prose-li:text-slate-600">
          {isPrivacy ? (
            <>
